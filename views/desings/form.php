...
$design_labels= array('Primary Color', '<br>Secondary Color', 'Main Color'/*, '<br>Accent Color'*/);
            ...
            foreach($colors as $color) echo " <div id='".$color."base2'><img id='".$color."imgbase2' src='assets/Uniforms/P".$p."D".$d."/JERSEY/design".$d."-".$color."2.png'/></div>";
...
//<!---<div id='".$color."sho2'><img id='".$color."imgsho2' src='assets/Uniforms/P".$p."D".$d."/SHORT/design".$d."-".$color."2.png'/></div>--->
          echo "</div>";
        echo "</div>";
          ...
          for ($h = 0; $h <sizeof($item_types); $h++) {
            ...
            for ($i = 0; $i <sizeof($colors_per_item); $i++) {
              ...
              for ($j = 0; $j <sizeof($colors); $j++) {
                //if($item_types[$h]!='sho' && $colors_per_item[$i]!='2'){
                ...
                if($item_types[$h]=='sho'){
                  if($colors_per_item[$i]=='2') $style='visibility:hidden';
                } 
